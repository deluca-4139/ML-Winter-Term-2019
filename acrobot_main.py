...
# The state is an array of 6 values which will be used as an input
...
with tf.Session() as sess:
    ...
    for episode in range(max_episodes):
        ...
        while True:
            ...
            # Choose action a
            action_probability_distribution = sess.run(action_distribution, feed_dict={input_: state.reshape([1,6])})
